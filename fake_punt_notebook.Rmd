...
There doesn't appear to be any relationship between how many points down the possessing team is and the chance of success.
```{r}
...
Slightly over half of fake punts on the opposing team's side of the field are successful, but over 70% of fake punts on the possessing team's side of the field are successful.
```{r}
...
Wide Receivers, Cornerbacks and Free Safeties are the most common tacklers. Linebackers are teh most common assisting tacklers.
```{r}
table(tackler_pos)
...
VIP seems to be Andy Lee.
Anti-VIP seems to be Jordan Berry
```{r}
...
Andy Lee tends to fake punt quicker than average successful plays.
```{r}
...
One of his plays had a very long pass delay and was still successful!
```{r}
